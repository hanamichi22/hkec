...
<div class="row">
    <div class="col-lg-6">
        <form id="form2" class="form-horizontal form-bordered" action="/bleg/edit" method="post" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="id" value="{{ $bleg->id }}" />
            <input type="hidden" name="photo_lama" value="{{ $bleg->photo }}" />
            <section class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="name" placeholder="type atlet name" value="{{ $bleg->name }}" class="form-control @error('name') is-invalid @enderror">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-3 text-center">
                            <img src="{{ url('/leg/'.$bleg->photo) }}" width="180" alt="">
                        </div>
                    </div>
