...
<div class="row">
    <div class="col-lg-6">
        <form id="form2" class="form-horizontal form-bordered" action="/mdcountry/add" method="post" enctype="multipart/form-data">
            @csrf
            <section class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="name" placeholder="E.g. : INDONESIA" class="form-control @error('name') is-invalid @enderror">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="iso" placeholder="E.g : ID" class="form-control @error('iso') is-invalid @enderror">
                            <div class="invalid-feedback">
                                @error('iso')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="nicename" placeholder="E.g : Indonesia" class="form-control @error('nicename') is-invalid @enderror">
                            <div class="invalid-feedback">
                                @error('nicename')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="iso3" placeholder="E.g : IDN" class="form-control @error('iso 3') is-invalid @enderror">
                            <div class="invalid-feedback">
                                @error('iso3')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="numcode" placeholder="E.g : 360" class="form-control @error('numcode') is-invalid @enderror">
                            <div class="invalid-feedback">
                                @error('numcode')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="phonecode" placeholder="E.g : +62" class="form-control @error('phonecode') is-invalid @enderror">
                            <div class="invalid-feedback">
                                @error('phonecode')
                                    {{ $message }}
                                @enderror
