...
<header class="page-header">
    ...
    <div class="right-wrapper text-right">
        <ol class="breadcrumbs">
            <li>
                <a href="{{ asset('templateadmin/') }}/index.html">
                    ...
                    <div class="col-xl-4 text-center">
                        ...
                        <div class="liquid-meter-wrapper liquid-meter-sm mt-3">
                            ...
                            <div class="liquid-meter-selector mt-4 pt-1" id="meterSalesSel">
                                <a href="{{ asset('templateadmin/') }}/#" data-val="35" class="active">Monthly Goal</a>
                                <a href="{{ asset('templateadmin/') }}/#" data-val="28">Annual Goal</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="widget-summary">
                            ...
                            <div class="widget-summary-col">
                                ...
                                <div class="summary-footer">
                                    <a class="text-muted text-uppercase" href="{{ asset('templateadmin/') }}/#">(view all)</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="widget-summary">
                            ...
                            <div class="widget-summary-col">
                                ...
                                <div class="summary-footer">
                                    <a class="text-muted text-uppercase" href="{{ asset('templateadmin/') }}/#">(withdraw)</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="widget-summary">
                            ...
                            <div class="widget-summary-col">
                                ...
                                <div class="summary-footer">
                                    <a class="text-muted text-uppercase" href="{{ asset('templateadmin/') }}/#">(statement)</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="widget-summary">
                            ...
                            <div class="widget-summary-col">
                                ...
                                <div class="summary-footer">
                                    <a class="text-muted text-uppercase" href="{{ asset('templateadmin/') }}/#">(report)</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="card">
            <header class="card-header">
                <div class="card-actions">
                    <a href="{{ asset('templateadmin/') }}/#" class="card-action card-action-toggle" data-card-toggle></a>
                    <a href="{{ asset('templateadmin/') }}/#" class="card-action card-action-dismiss" data-card-dismiss></a>
                </div>
                    ...
                    <header class="card-header bg-primary w-100">
                        ...
                        <div class="widget-profile-info">
                            <div class="profile-picture">
                                <img src="{{ asset('templateadmin/') }}/img/!logged-user.jpg">
                            </div>
                            <div class="profile-info">
                                <h4 class="name font-weight-semibold">John Doe</h4>
                                <h5 class="role">Administrator</h5>
                                <div class="profile-footer">
                                    <a href="{{ asset('templateadmin/') }}/#">(edit profile)</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="accordion" class="w-100">
                        <div class="card card-accordion card-accordion-first">
                            <div class="card-header border-bottom-0">
                                <h4 class="card-title">
                                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="{{ asset('templateadmin/') }}/#collapse1One">
                                    ...
                                    <ul class="widget-todo-list">
                                        <li>
                                            ...
                                            <div class="todo-actions">
                                                <a class="todo-remove" href="{{ asset('templateadmin/') }}/#">
                        ...
                        <div class="card card-accordion">
                            <div class="card-header border-bottom-0">
                                <h4 class="card-title">
                                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="{{ asset('templateadmin/') }}/#collapse1Two">
                                    ...
                                    <ul class="simple-user-list mb-3">
                                        <li>
                                            <figure class="image rounded">
                                                <img src="{{ asset('templateadmin/') }}/img/!sample-user.jpg" alt="Joseph Doe Junior" class="rounded-circle">
                                            </figure>
                                        ...
                                        <li>
                                            <figure class="image rounded">
                                                <img src="{{ asset('templateadmin/') }}/img/!sample-user.jpg" alt="Joseph Junior" class="rounded-circle">
                                            </figure>
                                        ...
                                        <li>
                                            <figure class="image rounded">
                                                <img src="{{ asset('templateadmin/') }}/img/!sample-user.jpg" alt="Joe Junior" class="rounded-circle">
                                            </figure>
            ...
            <div class="card-body">
                <div class="content">
                    ...
                    <div class="text-right">
                        <a class="text-uppercase text-muted" href="{{ asset('templateadmin/') }}/#">(View All)</a>
                    </div>
                </div>
            </div>
                            ...
                            <li>
                                <div class="tm-box">
                                    ...
                                    <div class="thumbnail-gallery">
                                        <a class="img-thumbnail lightbox" href="{{ asset('templateadmin/') }}/img/projects/project-4.jpg" data-plugin-options='{ "type":"image" }'>
                                            <img class="img-fluid" width="215" src="{{ asset('templateadmin/') }}/img/projects/project-4.jpg">
                                            <span class="zoom">
