    ...
    <div class="container">
        ...
        <div class="row py-5 my-4">
            <div class="col-md-6 mb-4 mb-lg-0">
                <div class="row">
                <div class="col-md-3">
                    <a href="{{ asset('template/') }}/index.html" class="logo pe-0 pe-lg-3">
                        <img alt="Porto Website Template" src="{{ asset('template/') }}/img/logohkendurance.png" class="opacity-7 bottom-4" height="100">
                    </a>
                </div>
                <div class="col-md-9">
                    <p class="mt-2 mb-2">
